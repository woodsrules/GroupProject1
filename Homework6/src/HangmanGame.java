...
public class HangmanGame {
	...
	public static void main(String[] args) {
		...
		String[] words = { "soup", "chicken", "meat", "cake", 
				"pizza", "burger", "hotdog", "steak", "pasta", 
				"icecream", "sleep" };
		String answer;
		// this is my do while loop that will keep everything 
		// going
		do {
			...
			while (howManyYouGotCorrect != word.length) {
				System.out.print("Try and enter the " +
						"correct letter for the mystery " +
						"word given ");
				// this is where i will be printing out the 
				// users results
			...
			System.out.println("The mystery word is " + 
					String.valueOf(word) + 
					". You answered incorrectly " + 
					howManyYouMissed + " times");
			System.out.print("Do you want to play again? " +
					"Enter y/n");
			answer = input.next();
		} while (answer.charAt(0) != 'n');
	}
	public static int intRandom(int lowerBound, 
			int upperBound) {
